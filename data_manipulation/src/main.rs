...
fn struct_oriented_result(
    ...
    //     .collect::<Vec<_>>();
    // let mut wtr =
    //     csv::Writer::from_path("/home/scrad/Documents/rust_test/output_rust_groupby.csv")
    //         .unwrap();
    //
    // for group in &groups {
    //     wtr.serialize(group)?;
...
/*
    ...
    let mut wtr = csv::Writer::from_path(
        "/home/scrad/Documents/rust_test/output_rust_mutation.csv",
    )?;
    for record in &records {
        wtr.serialize(record)?;
    }*/
    ...
    // }
    // let mut wtr =
    //     csv::Writer::from_path("/home/scrad/Documents/rust_test/output_rust_join.csv")
    //         .unwrap();
    // for record in &records {
    //     wtr.serialize(record)?;
    // }
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let path = "/home/scrad/Documents/globalterrorismdb_0718dist.csv";
    let path_country = "/home/scrad/Documents/WDICountry.csv";
    // inspect_schema(path);
